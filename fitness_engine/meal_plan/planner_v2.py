"""
Meal planner — Phase-5 clean 7-day orchestrator.

This module REPLACES the legacy Phase-2 planner with a clean, comprehensive
7-day meal plan generator that uses:
  - profile_requirements.compute_meal_plan_requirements (per-slot targets)
  - allocator_v2.allocate_meal (recipe + scaling + fillers per slot)
...
from .allocator_v2 import allocate_meal, SelectedMeal, selected_meal_to_dict
